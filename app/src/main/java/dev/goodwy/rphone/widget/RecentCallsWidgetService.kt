package dev.goodwy.rphone.widget
...
class RecentCallsFactory(
    ...
    companion object {
        ...
        fun saveCache(context: Context, entries: List<WidgetCallEntry>) {
            ...
            context.getSharedPreferences(PREFS_NAME, Context.MODE_PRIVATE)
                .edit { putString(KEY_CACHED_CALLS, arr.toString()) }
        }
    ...
    override fun getViewAt(position: Int): RemoteViews {
        ...
        val iconRes = when (entry.type) {
            ...
            CallLog.Calls.REJECTED_TYPE   -> R.drawable.ic_widget_missed
            CallLog.Calls.BLOCKED_TYPE   -> R.drawable.ic_widget_missed
    ...
    private fun formatRelativeTime(timestamp: Long): String {
        ...
        return when {
            diff < DateUtils.MINUTE_IN_MILLIS -> context.getString(R.string.just_now)
            ...
            DateUtils.isToday(timestamp + DateUtils.DAY_IN_MILLIS) -> context.getString(R.string.yesterday)
